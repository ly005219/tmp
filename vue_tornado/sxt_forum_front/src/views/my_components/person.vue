<template>
  <div>
    ...
    <div class="person_item">
      ...
      <div class="person_item_detail">{{user.nick_name}}</div>
    </div>
    <div class="person_item">
      <label class="person_item_label">性别</label>
      <div class="person_item_detail" v-if="+user.gender == '1'">男</div>
      <div class="person_item_detail" v-if="+user.gender == '2'">女</div>
    ...
    <div class="person_signature">
      ...
      <div class="person_signature_detail">{{user.signatrue}}</div>
    </div>
